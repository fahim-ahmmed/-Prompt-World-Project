...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // ১. Window/LocalStorage চেক
    if (typeof window === "undefined") return;

    const token = localStorage.getItem("token");
    const storedUser = localStorage.getItem("user");

    // টোকেন বা ইউজার না থাকলে কেবল তখনই লগইনে রিডাইরেক্ট করবে
    ...
    // ২. ব্যাকএন্ড থেকে ডেটা ফেচ করা (API এরর আসলেও লগআউট করাবে না)
    const fetchUserPrompts = async () => {
      try {
        ...
        const res = await fetch(`${cleanUrl}/api/prompts/my-prompts`, {
          headers: {
        ...
        if (res.ok) {
          ...
          // কেবল টোকেন সত্যি ইনভ্যালিড হলে লগআউট করাবে
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0d111a] p-6 md:p-8 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="relative z-10 flex items-center gap-5">
          <div className="h-16 w-16 md:h-20 md:w-20 rounded-2xl bg-gradient-to-br from-violet to-purple-600 border-2 border-violet/60 text-white flex items-center justify-center font-display text-2xl font-black shadow-2xl overflow-hidden shrink-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-between">
            ...
            <span className="text-xs font-bold text-mist group-hover:text-violet transition-colors">
              →
            </span>
          </div>
          ...
          <div className="relative z-10">
            ...
            <p className="mt-1 text-xs text-mist">
              Publish new AI prompt to marketplace
            </p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mt-1 text-xs text-mist">
              Find curated ChatGPT & Midjourney prompts
            </p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mt-1 text-xs text-mist">
              Access your bookmarked prompts fast
            </p>
          </div>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-3xl border border-white/5 bg-[#0d111a]/60 p-6 shadow-xl">
          <p className="text-[11px] font-extrabold uppercase tracking-widest text-mist">
            Account Role
          </p>
          <p className="mt-2 font-display text-2xl font-black text-white uppercase tracking-wider">
            {user?.role || "USER"}
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-white/5 bg-[#0d111a]/60 p-6 shadow-xl">
          ...
          <p className="mt-2 font-display text-2xl font-black text-violet capitalize">
            {user?.subscription || "Free"}
          </p>
        </div>
      </div>
      ...
      <div className="rounded-3xl border border-white/10 bg-[#0d111a] p-6 md:p-8 shadow-2xl space-y-5">
        <div className="flex items-center justify-between border-b border-white/5 pb-4">
          ...
          <Link
            ...
            className="text-xs text-violet hover:underline font-bold"
          >
            ...
            {myPrompts.slice(0, 3).map((prompt) => (
              ...
              >
                <div>
                  ...
                  <p className="mt-1 text-[11px] text-mist line-clamp-1">
                    {prompt.description}
                  </p>
                </div>
                <span
      ...
      {/* 5. Trending Categories & Creator Guidelines Banner */}
        ...
        <div className="relative overflow-hidden rounded-3xl border border-violet/30 bg-gradient-to-br from-violet/20 via-[#0d111a] to-[#0d111a] p-6 md:p-8 shadow-2xl space-y-2 flex flex-col justify-between">
          ...
          <div className="relative z-10 space-y-2">
            ...
            <p className="text-xs text-mist leading-relaxed">
              Include clear variable placeholders (e.g.,{" "}
              <code className="text-violet">[YOUR_TOPIC]</code>), precise output
              formats, and example outputs to boost copy rates.
            </p>
          </div>
        </div>
      </div>
